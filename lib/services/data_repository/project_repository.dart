...
class ProjectRepository {
  ...
  Stream<List<ProjectModel>> loadProjects(int stageNum) =>
      _firestoreService.collectionStream(
          ...
          sort: (ProjectModel a, ProjectModel b) => a.stepNum.compareTo(b.stepNum));
  ...
  Future<void> addProject() async {
    var str =
        await FirebaseFirestore.instance.collection('Projects').doc().id;
    try {
      await _firestoreService.setData(
