...
import 'logic_check_screen.dart';

class LogicDesignScreen extends StatefulWidget {
  @override
  _LogicDesignScreenState createState() => _LogicDesignScreenState();
}

class _LogicDesignScreenState extends State<LogicDesignScreen> {
                              ...
                              UserProvider.isTouchCoding()
                                  ...
                                  MaterialPageRoute(
                                      builder: (BuildContext context) =>
                                          ChangeNotifierProvider.value(
                                              value: projectProvider,
                                              child: LogicCheckScreen()//CameraLogicCheck() 
                                          ))),
                            );
                          })),
            )
